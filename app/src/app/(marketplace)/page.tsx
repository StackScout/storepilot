      ...
      <section className="from-primary/10 via-primary/5 rounded-2xl bg-gradient-to-br to-transparent px-6 py-10 sm:px-10 sm:py-14">
        <div className="max-w-2xl space-y-4">
          <h1 className="text-3xl leading-tight font-bold text-balance sm:text-4xl">
            Shop directly from Sri Lanka&apos;s small businesses
          </h1>
          <p className="text-muted-foreground text-base sm:text-lg">
            Fresh spices from Kandy, hand-painted batik from Galle, certified gems from
            Ratnapura — discover and buy from verified local sellers, with secure online
