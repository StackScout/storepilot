...
dependencies {
	...
	// Plain unit tests only (mocked repositories/collaborators, no Spring
	// context) — see backend/src/test/kotlin's *ServiceTest.kt files.
	// MockK over Mockito for idiomatic Kotlin mocking (relaxed mocks,
	// `every { }`/`verify { }` syntax) — not previously a dependency here.
