...
class CouponController(
    ...
    ): PageResponse<CouponResponse> = couponService.listForStore(storeId, page, size)
    ...
    fun listPlatformWide(
        @RequestParam(defaultValue = "0") page: Int,
        @RequestParam(defaultValue = "20") size: Int,
    ): PageResponse<CouponResponse> = couponService.listPlatformWide(page, size)
