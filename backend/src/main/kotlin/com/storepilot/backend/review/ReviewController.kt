...
class ReviewController(
    ...
    fun listByProduct(@PathVariable productId: UUID): List<ReviewResponse> = reviewService.listByProduct(productId)
    ...
    fun listByStore(@PathVariable storeId: UUID): List<ReviewResponse> = reviewService.listByStore(storeId)
